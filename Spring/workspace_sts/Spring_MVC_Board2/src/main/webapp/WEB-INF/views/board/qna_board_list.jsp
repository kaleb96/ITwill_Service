	...
	<section id="buttonArea">
		...
		<form action="BoardList.bo" method="get">
			<select name="searchType">
				<option value="subject" <c:if test="${param.searchType ne null and param.searchType eq 'subject'}">selected</c:if>>제목</option>
				<option value="content" <c:if test="${param.searchType ne null and param.searchType eq 'content'}">selected</c:if>>내용</option>
				<option value="name" <c:if test="${param.searchType ne null and param.searchType eq 'name'}">selected</c:if>>작성자</option>
			</select>
			<input type="text" name="keyword" required="required" <c:if test="${param.keyword ne null }">value="${param.keyword }"</c:if>>
