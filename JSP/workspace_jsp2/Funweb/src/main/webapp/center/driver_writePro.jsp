...
// 1. 업로드 할 파일에 저장되는 이클립스 프로젝트 상의 폴더를 변수에 저장(= 가상의 폴더)
String uploadPath = "/upload"; // 루트(webapp)에 생성한 upload폴더 지정
...
// D:\workspace_jsp2\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\Funweb\ upload
//String realPath = context.getRealPath(uploadPath);
...
MultipartRequest multi = new MultipartRequest(
		request,  //1)실제 요청 정보가 포함된 request객체
