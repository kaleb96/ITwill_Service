...
<body>
	...
	2. DB 연결(접속)
	   ...
	   < 문법 >
	   Connection con = DriverManager.getConnection("URL", "계정명", "패스워드");
	...
	*/
	...
	// 3단계. SQL 구문 작성 및 전달
	// 1) SQL 구문 작성
	int num = 15; // 외부로부터 입력받은 데이터를 변수에 저장했다고 가정
	String name = "홍길동";
	
	// test 테이블의 idx 컬럼에 변수 num 의 데이터 추가 시
	// 문자열 결합을 통해 변수값을 지정할 경우
	String sql = "INSERT INTO test VALUES(" + num + ")";
// 	String sql = "INSERT INTO test2 VALUES('" + name + "')";
// 	String sql = "INSERT INTO test3 VALUES(" + num + ",'" + name + "')";
